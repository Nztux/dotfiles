 ...
 *6)emptycol         */
static const char *colors[] = {"#DADADA","#333333","#7a8c5c","#ff6666","#333333","#333333","#DADADA"};
/*
...
static const uint8_t borders[] = {0,3,5,4};
...
static const char *rxvt[]      = { "urxvt", NULL};
...
static key keys[] = {
    ...
    // Start programs
    {  MOD ,              XK_Return,     start,             {.com = rxvt}},
    {  MOD ,              XK_w,          start,             {.com = menucmd}},
    {  MOD |SHIFT,        XK_g,          start,             {.com = gmrun}},
